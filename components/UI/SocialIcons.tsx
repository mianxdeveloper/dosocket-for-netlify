    ...
    <>
      ...
      <div className="card">
        ...
        <a
          ...
          href="https://www.instagram.com/dosocketagency/"
        >
          <svg
            style={{ color: "white" }}
        ...
        <a
          ...
          href="https://www.facebook.com/DosocketAgency"
        >
          <svg
            viewBox="0 0 320 512"
            height="1em"
        ...
        {/* X (Twitter) */}
        <a className="social-link3" href="https://x.com/dosocketagency">
          <svg
            viewBox="0 0 512 512"
            height="1em"
            fill="#fff"
        ...
        <a
          ...
          href="https://www.linkedin.com/in/dosocket-agency-146a6b3b1/"
        >
          <svg
            fill="#fff"
            viewBox="0 0 448 512"
