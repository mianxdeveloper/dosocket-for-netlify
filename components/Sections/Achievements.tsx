      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {stats.map((stat) => (
            <div
              key={stat.id}
              className="bg-white/80 backdrop-blur-sm border border-gray-100 p-6 md:p-8 rounded-2xl hover:border-dosocket-700/20 hover:shadow-lg transition-all duration-500 group"
            >
              <span className="block text-xs uppercase tracking-widest text-gray-400 mb-8">
                {stat.label}
              </span>
